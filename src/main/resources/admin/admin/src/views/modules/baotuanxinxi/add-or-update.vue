	...
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="报名人数" prop="xianluminge">
					<el-input v-model="xianluminge" placeholder="报名人数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.xianluminge" label="报名人数" prop="xianluminge">
					<el-input v-model="ruleForm.xianluminge" placeholder="报名人数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="报团金额" prop="baotuanjine">
					<el-input-number v-model="ruleForm.baotuanjine" placeholder="报团金额" :readonly="ro.baotuanjine"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="报团金额" prop="baotuanjine">
					<el-input v-model="ruleForm.baotuanjine" placeholder="报团金额" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="报团时间" prop="baotuanshijian">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.baotuanshijian" 
						type="date"
						:readonly="ro.baotuanshijian"
						placeholder="报团时间"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.baotuanshijian" label="报团时间" prop="baotuanshijian">
					<el-input v-model="ruleForm.baotuanshijian" placeholder="报团时间" readonly></el-input>
				</el-form-item>
			</template>
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      ...
	      objcross.xianluminge = objcross.xianluminge - this.ruleForm.xianluminge
	      if(objcross.xianluminge<0){
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `baotuanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.baotuanxinxiCrossAddOrUpdateFlag = false;
											this.parent.search();
