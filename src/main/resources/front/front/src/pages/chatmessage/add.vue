...
<div :style='{"border":"2px solid #DF847F","width":"90%","padding":"20px 0","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="格式(1:文字，2:图片)" prop="format">
            <el-input v-model.number="ruleForm.format" 
                placeholder="格式(1:文字，2:图片)" clearable :disabled=" false  ||ro.format"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="消息已读(0:未读，1:已读)" prop="isread">
