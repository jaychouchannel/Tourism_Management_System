...
<div :style='{"border":"2px solid #DF847F","width":"90%","padding":"20px 0","margin":"10px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="攻略标题" prop="gonglvebiaoti">
            <el-input v-model="ruleForm.gonglvebiaoti" 
                placeholder="攻略标题" clearable :disabled=" false  ||ro.gonglvebiaoti"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="景点封面" v-if="type!='cross' || (type=='cross' && !ro.jingdianfengmian)" prop="jingdianfengmian">
            <file-upload
            tip="点击上传景点封面"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' class="upload" v-else label="景点封面" prop="jingdianfengmian">
                ...
                <img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jingdianfengmian.split(',')" :src="baseUrl+item" width="100" height="100">
            </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}'  label="包含景点" prop="jingdianmingcheng">
            <el-select v-model="ruleForm.jingdianmingcheng" placeholder="请选择包含景点" :disabled=" false  ||ro.jingdianmingcheng" multiple filterable>
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="出发城市" prop="chufachengshi">
            <el-input v-model="ruleForm.chufachengshi" 
                placeholder="出发城市" clearable :disabled=" false  ||ro.chufachengshi"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="行程天数" prop="xingchengtianshu">
            <el-input v-model="ruleForm.xingchengtianshu" 
                placeholder="行程天数" clearable :disabled=" false  ||ro.xingchengtianshu"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="行程距离" prop="xingchengjuli">
            <el-input v-model="ruleForm.xingchengjuli" 
                placeholder="行程距离" clearable :disabled=" false  ||ro.xingchengjuli"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}'  label="交通工具" prop="jiaotonggongju">
            <el-select v-model="ruleForm.jiaotonggongju" placeholder="请选择交通工具" :disabled=" false  ||ro.jiaotonggongju" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="行程路线" prop="xingchengluxian">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="行程路线"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="攻略详情" prop="gonglvexiangqing">
            <editor 
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='jingdianfengmian'){
              this.ruleForm.jingdianfengmian = obj[o].split(",")[0];
        ...
        this.$http.get('option/remenjingdian/jingdianmingcheng', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
    ...
    // 多级联动参数
      ...
      jingdianfengmianUploadChange(fileUrls) {
          this.ruleForm.jingdianfengmian = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");;
      },
    }
  };
</script>
